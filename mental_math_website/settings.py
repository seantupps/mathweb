"""
Django settings for mental_math_website project.
...
ALLOWED_HOSTS = ['mathweb-kuml.onrender.com', 'localhost', '127.0.0.1']
...
ROOT_URLCONF = 'mental_math_website.urls'
...
WSGI_APPLICATION = 'mental_math_website.wsgi.application'
